            ...
            <div class="card mb-4">
                <div class="card-header px-7 pb-0">
                    ...
                    <div class="col-md-12 text-right">
                        <button onclick="window.location.href='{{ route('admin.create4') }}'"
                            class="btn btn bg-gradient-primary btn-sm mb-0">Tambah surat perintah tugas</button>
                    </div>
                </div>
                <div class="card-header px-7 pb-0">
                    <h5>Export to: </h5>
                    <div class="col-md-12 text-right">
                        <button onclick="window.location.href='{{ route('admin.hsupe') }}'"
                        ...
                        <table id="dataTable">
                            <thead>
                                ...
                                <tr>
                                    ...
                                    <th class="text-uppercase text-primary font-weight-bolder opacity-8">
                                        tanggal kembali</th>
