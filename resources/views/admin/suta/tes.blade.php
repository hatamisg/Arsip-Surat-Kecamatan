            ...
            <div class="card mb-4">
                <div class="card-header px-7 pb-0">
                    ...
                    <div class="col-md-12 text-right">
                        <button onclick="window.location.href='{{ route('admin.create3') }}'"
                            class="btn btn bg-gradient-primary btn-sm mb-0">Tambah surat tanah</button>
                    </div>
                </div>
                <div class="card-header px-7 pb-0">
                    <h5>Export to: </h5>
