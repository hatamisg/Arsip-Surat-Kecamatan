<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-left ms-3"
    ...
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href="{{ route('admin.') }}">
            <img src="{{ asset('assets/assets/img/yok3.png') }}" class="navbar-brand-img h-100 w-15" alt="...">
            <span class="ms-1 font-weight-bold">Arsip Surat</span>
        </a>
    </div>
    ...
    <div class="collapse navbar-collapse  w-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            <li class="nav-item">
                <a class="nav-link {{ request()->is('arsip') ? 'active' : '' }}" href="{{ route('admin.') }}">
                    <div
            ...
            <li class="nav-item">
                <a class="nav-link  {{ request()->is('arsip/surat-masuk') ? 'active' : '' }}"
                    href="{{ route('admin.tes') }}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link  {{ request()->is('arsip/surat-keluar') ? 'active' : '' }}"
                    href="{{ route('admin.tes2') }}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link {{ request()->is('arsip/surat-tanah') ? 'active' : '' }}"
                    href="{{ route('admin.tes3') }}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg width="12px" height="12px" viewBox="0 0 45 40" version="1.1"
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                    ...
                    <span class="nav-link-text ms-1">Surat Tanah</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ request()->is('arsip/surat-perintah') ? 'active' : '' }}"
                    href="{{ route('admin.tes4') }}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg width="12px" height="12px" viewBox="0 0 45 40" version="1.1"
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
            ...
            @role('admin')
                ...
                <li class="nav-item">
                    <a class="nav-link {{ request()->is('arsip/user') ? 'active' : '' }} "
                        href="{{ route('admin.indexorang') }}">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
